...
public class KafkaMessageProcessor implements Runnable {
    ...
    private void processProductInfoChangeMessage(JSONObject messageJSONObject) {
        ...
        String productInfoJSON = "{\"id\": 5, \"name\": \"iphone7手机\", \"price\": 5599, " +
				"\"pictureList\":\"a.jpg,b.jpg\", \"specification\": \"iphone7的规格\", \"service\": " +
        ...
        if (existedProductInfo != null) {
            ...
            try {
                ...
                if (date.before(existedDate)) {
                    System.out.println("current date[" + productInfo.getModifiedTime() + "] is " +
							"before existed date[" + existedProductInfo.getModifiedTime() + "]");
                    return;
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
            System.out.println("current date[" + productInfo.getModifiedTime() + "] is after " +
					"existed date[" + existedProductInfo.getModifiedTime() + "]");
        } else {
