package com.roncoo.trainshop.cache.prewarm;
    ...
    public void run() {
        ...
        if (taskidList != null && !"".equals(taskidList)) {
            ...
            for (String taskid : taskidListSplited) {
                ...
                System.out.println("【CachePrewarmThread获取task的预热状态】taskid=" + taskid + ", status" +
						"=" + taskidStatus);

                if ("".equals(taskidStatus)) {
                    String productidList =
							zkSession.getNodeData("/task-hot-product-list-" + taskid);
                    ...
                    for (int i = 0; i < productidJSONArray.size(); i++) {
                        ...
                        String productInfoJSON = "{\"id\": " + productId + ", \"name\": " +
								"\"iphone7手机\", \"price\": 5599, \"pictureList\":\"a.jpg,b.jpg\", " +
								"\"specification\": \"iphone7的规格\", \"service\": \"iphone7的售后服务\"," +
								" \"color\": \"红色,白色,黑色\", \"size\": \"5.5\", \"shopId\": 1, " +
								"\"modifiedTime\": \"2017-01-01 12:00:00\"}";
                        ProductInfo productInfo = JSONObject.parseObject(productInfoJSON,
								ProductInfo.class);
